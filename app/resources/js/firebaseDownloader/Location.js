class Location {
    constructor(art, city, housenumber, image, info, isPremiumLocation, isPremiumMapIcon, name, street, zip,
        monday_from, monday_till, tuesday_from, tuesday_till, wednesday_from, wednesday_till, thursday_from,
        thursday_till, friday_from, friday_till, saturday_from, saturday_till, sunday_from, sunday_till) {
        this.art = art;
        this.city = city;
