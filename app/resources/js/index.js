...
let eventListView, eventFilter, events, locations;
...
function onFilterRequested() {
  ...
  FilterView.setupFilterView(
    eventFilter.getListOfAvailableMusicGenres(),
    eventFilter.getListOfAvailableLocationsTypes(),
    eventFilter.getMaxPriceOfAllEvents()
  );
}
